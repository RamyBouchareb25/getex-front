    ...
    return (
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="text-center space-y-3">
          ...
          <h3 className="font-semibold text-lg">{t('returnCartEmpty')}</h3>
          <p className="text-sm text-muted-foreground">{t('scanToReturn')}</p>
        </div>
      </div>
    )
  }
    ...
    <>
      ...
      <div className="border-t border-border p-4 space-y-4">
        <div className="space-y-2 text-sm">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Checkbox id="return-tax" checked={includeTax} onCheckedChange={onToggleTax} />
              <Label htmlFor="return-tax" className="text-muted-foreground cursor-pointer">
                {t('taxOptional')} (19%)
              </Label>
            </div>
        ...
        <div className="space-y-2">
          <Button onClick={onCompleteReturn} size="lg" className="w-full">
            {t('completeReturn')}
          </Button>
